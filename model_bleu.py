...
def test(args):
    ...
    '''
    train_json_path = 'annotations/captions_train2014.json'
    test_json_path = 'annotations/captions_val2014.json'
    train_image_dir = 'data/resized2014'
    test_image_dir = 'data/val_resized2014'
    ...
    # Build model
    encoder = EncoderCNN(embed_size=args.embed_size).eval()
    decoder = DecoderRNN( embed_size=args.embed_size, hidden_size=args.hidden_size, vocab_size=len(vocab), num_layers=args.num_layers).eval()
